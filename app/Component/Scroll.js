      ...
      <div className={styles.main1}>
        <div className={styles.App} ref={component}>
          <div className={styles.firstContainer}>
            ...
            <div >
              <img style={{ width: "600px", height: "350px" }} className={styles.img1} src="./images/robotics.jpg" alt="AI image" />
            </div>

            <div className={styles.headin}>Our comprehensive range of the cutting-edge services includes Hotel <br /> Robots & Dokat Robots for enhanced hospitality experiences,
              F1 and <br /> Flight Motion Simulators for realistic and thrilling simulations,Hot Air <br />Balloon adventures providing the breathtaking views,
              and innovative <br />solutions like Dotkeeper, Dotwaiter, and Dot Teleport revolutionizing <br />security and service industries.
            </div>

            <div >
              <img style={{ width: "600px", height: "350px" }} className={styles.img2} src="./images/ai.jpg" alt="AI image" />
            </div>

            <div className={styles.headin1}>Engaging in groundbreaking research on the Humanoid robots, we aim <br /> to combine AI and robotics seamlessly.Further,our offerings
          ...
          <div ref={slider} className={styles.container}>
            ...
            <div id="panel" className={`${styles.description} ${styles.panel} ${styles.blue}`}>
              ...
              <div >
                <img style={{ width: "500px", height: "300px" }} className={styles.img2} src="./images/hotel_robot.webp" alt="AI image" />
              </div>
            ...
            <div id="panel" className={`${styles.panel} ${styles.red}`}>
              ...
              <div >
                <img style={{ width: "500px", height: "300px" }} className={styles.img2} src="./images/balloon_home.png" alt="AI image" />
              </div>
              ...
              <div className={styles.headin41}>
                ...
                Hot air balloon is a popular < br />recreational  activity and sport, offering
            ...
            <div id="panel" className={`${styles.panel} ${styles.orange}`}>
              ...
              <div >
                <img style={{ width: "500px", height: "300px" }} className={styles.img2} src="./images/mobilerobot0.jpg" alt="AI image" />
              </div>
            ...
            <div id="panel" className={`${styles.panel} ${styles.purple}`}>
              ...
              <div >
                <img style={{ width: "500px", height: "300px" }} className={styles.img2} src="./images/roboface.jpg" alt="AI image" />
              </div>

              <div className={styles.headin3}>
                Realistic humaniod for research and development
              </div>


              <div className={styles.headin43}>
                Humanoid robots, designed with human-like features and capabilities, play the<br/> pivotal roles across diverse domains.
                ...
                exhibitions, and theme parks, captivating audiences as performers <br/>and also the interactive exhibits.
